...
(1, 'Rahul', 'rahul@supercare.com', 'rk09');
...
(1, 'Logitech MQ5 Gaming Keyboard ', '2021-07-01', 4, 5, 1000, 1500),
(2, 'Logitech MQ5 Gaming Mouse', '2021-07-01', 5, 5, 700, 1000),
(3, 'Samsung 32 inch 4K Monitor', '2021-07-01', 3, 3, 30000, 37000),
(4, 'Samsung 24 inch 4K Monitor', '2021-07-01', 1, 2, 22000, 25000);
...
(1, 1, 'Redmi Note 10 display broken.', 'Phone fell and display cracked. Need a new display.', 'Ankit', 'Sonari', 'East Phase', 'Jamshedpur', 'Jharkhand', 831005, 'ankit@gmail.com', 9876543210, 'Ram', '2021-07-05');
...
(1, 'Kunal', 'Kadma', 'Logitech MQ5 Gaming Keyboard ', 1, 1500, 1500, '2021-07-05');
...
(1, 'Redmi Note 10 display broken.', 'Phone fell and display cracked. Need a new display.', 'Ankit', 'Sonari', 'East Phase', 'Jamshedpur', 'Jharkhand', 831005, 'ankit@gmail.com', 9876543210, '2021-07-05'),
(2, 'New Desktop Monitor required.', 'I want a Gaming monitor.', 'Aman', 'Bistupur', 'K Road', 'Jamshedpur', 'Jharkhand', 831001, 'aman@gmail.com', 9876543211, '2021-07-05');
...
(1, 'Ram', 'Jamshedpur', 9876543210, 'ram@supercare.com'),
(2, 'Shyam', 'Ranchi', 9123456780, 'shyam@supercare.com');
