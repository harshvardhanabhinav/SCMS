  ...
  <div class="row mt-4 mb-4">
    <div class="col-md-6 offset-md-3">
      <form action="" class="shadow-lg p-4" method="POST">
        ...
        <div class="form-group">
          <i class="fas fa-envelope"></i><label for="email" class="pl-2 font-weight-bold">Email</label><input type="email" class="form-control" placeholder="Email" name="rEmail">
        ...
        <button type="submit" class="btn btn-outline-success mt-5 btn-block shadow-sm font-weight-bold" name="rSignup">Sign Up</button>
